...
using P4PhaseEndProject.Models;

namespace p4phaseend.Controllers
{
    public class CustLogInfoesController : Controller
    {
        private readonly P4PhaseEndProjectContext _context;

        public CustLogInfoesController(P4PhaseEndProjectContext context)
        {
            _context = context;
        }
        ...
        {
            var s10phaseendContext = _context.CustLogInfos.Include(c => c.User);
            return View(await s10phaseendContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'S10phaseendContext.CustLogInfos'  is null.");
            }
            var custLogInfo = await _context.CustLogInfos.FindAsync(id);
            if (custLogInfo != null)
            {
