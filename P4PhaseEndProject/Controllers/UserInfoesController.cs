...
namespace P4PhaseEndProject.Controllers
{
    public class UserInfoesController : Controller
    {
        private readonly P4PhaseEndProjectContext _context;

        public UserInfoesController(P4PhaseEndProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.UserInfos != null ? 
                          ...
                          Problem("Entity set 'P4PhaseEndProjectContext.UserInfos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'P4PhaseEndProjectContext.UserInfos'  is null.");
            }
            var userInfo = await _context.UserInfos.FindAsync(id);
            if (userInfo != null)
            {
